#define IO_USERNAME "mtdspeedy98"
#define IO_KEY "aio_gWva31CbV8sSJ20ZkRoHLu6YfKtg"
...
const char* ssid     = "dlink-34EC";
const char* password = "lnbfu70340";
int8_t utc_offset = -5; // hours off of UTC, e.g. EST is -5 
const char* location = "toronto%2C%20ma";
